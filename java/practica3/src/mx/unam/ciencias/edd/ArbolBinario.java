...
public abstract class ArbolBinario<T> implements Coleccion<T> {
    ...
    protected class Vertice implements VerticeArbolBinario<T> {
        ...
        private boolean auxEquals(Vertice v1, Vertice v2) {
            if (v1 == null && v2 == null)
                return true;
            ...
            return auxEquals(v1.izquierdo, v2.izquierdo) && auxEquals(v1.derecho, v2.derecho);
        }
    }
    ...
    private int auxProfundidad(Vertice vertice) {
        if (vertice == null)
            return -1;
        return 1 + Math.max(auxProfundidad(vertice.izquierdo), auxProfundidad(vertice.derecho));
    }
    ...
    protected Vertice busca(Vertice vertice, T elemento) {
        ...
        Vertice v1 = busca(vertice.izquierdo, elemento);
        Vertice v2 = busca(vertice.derecho, elemento);
    ...
    @Override public boolean equals(Object o) {
        ...
        return (esVacio() && arbol.esVacio()) || raiz.equals(arbol.raiz);
    }
